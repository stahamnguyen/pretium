//
//  CheckMarkOfCollectionViewCell.swift
//  Pretium
//
...
class CheckMarkViewInCollectionViewCell: UIView {
    
    private var checkedBool = false
    // choose whether you like open or grayed out non-selected items
    private var checkMarkStyleReal: SSCheckMarkStyle = .GrayedOut
    ...
    private func drawRectChecked(rect: CGRect) {
    ...
    private func drawRectGrayedOut(rect: CGRect) {
        let context = UIGraphicsGetCurrentContext()
    ...
    private func drawRectOpenCircle(rect: CGRect) {
        let context = UIGraphicsGetCurrentContext()
